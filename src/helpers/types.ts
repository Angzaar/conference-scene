...
export enum SERVER_MESSAGE_TYPES {
    ...
    //conference//
    CONFERENCE_IMAGE_UPDATE = 'conference_image_update',
    CONFERENCE_VIDEO_UPDATE = 'conference_video_update',
    CONFERENCE_CLEAR = 'clear-conference',
    CONFERENCE_REFRESH = 'refresh-conference',
    CONFERENCE_ADD_RESERVATION = 'new-conference-reservation',
    CONFERENCE_CANCEL_RESERVATION = 'cancel-conference-reservation',
}
