...
export function outputBuilderHUDJSON(){
  let output:any[] = []
  builderHUDEntities.forEach((entity:Entity)=>{
...
export function addBuilderHUDAsset(entity:Entity, label:string){
  if(Transform.has(entity) && !builderHUDEntities.find((e) => e === entity)){
    ...
    // angzaarLog('added object to builder hud', builderHUDEntities, builderHUDLabels)
  }
}
